...
<?php
	$controller->widget('zii.widgets.grid.CGridView', [
		...
		'columns'=>[
			...
			'pp_vendor',
			'pp_number',
			['name'=>'pp_replacenumber',
			'type' => "raw",
			//'value' => 'CHtml::link($data->pp_replacenumber,$data->getReplacementPriceUrl())'
			'value' => 'CHtml::link($data->pp_replacenumber,Yii::app()->createUrl("price/priced/index").$data->getReplacementPriceUrl())',
			],
			'pp_desc_en',
			'pp_desc_ru',
			'pp_depot',
